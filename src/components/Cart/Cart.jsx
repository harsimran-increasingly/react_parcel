    ...
    <div className="inc_pdp_bundle_cart">
      ...
      <div className="inc_pdp_bundle_cart_block">
        <div className="inc_pdp_bundle_cart_added_products">
          {cart && cart.map((product) => (<div className='inc_pdp_bundle_cart_product'>
            <img className="inc_pdp_bundle_cart_product_image" src={product.ImageURL} alt={product.ProductName} />
            ...
            <button type='button' className='inc_pdp_bundle_cart_product_remove' onClick={() => removeFromStore(product.ProductId)}>X</button>
          </div>))}
        </div>
        <div className='inc_pdp_bundle_cart_footer'>
          ...
          <button type='button' className="inc_pdp_bundle_cart_button">Add To Bundle</button>
        </div>
      </div>
    </div>
  )
